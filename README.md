...
- Task 07 已完成五个生产边界：Pydantic v2 HTTP 契约/隐私适配器、原子内存 Run Repository、带显式 migration 和 COMMIT-unknown 对账的 PostgreSQL Run/event Repository、FastAPI Run Gateway，以及支持严格断点续传/heartbeat/连接治理的有界 SSE 回放。
