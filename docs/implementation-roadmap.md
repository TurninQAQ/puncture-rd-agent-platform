...
2026-07-15 已新增并实跑 loopback 全栈入口：真实 FastAPI/PostgreSQL、Qwen/vLLM、
OpenSearch、两个 Agent 工作流、JSON/SSE 与幂等重放组成一条命令的现场演示；算法端仍为
确定性合成工具，详见
[本机证据](../deploy/local-demo/evidence/local-full-stack-validation.md)。
